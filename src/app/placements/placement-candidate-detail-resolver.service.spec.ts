...
describe('PlacementCandidateDetailResolverService', () => {
  let service: PlacementCandidateDetailResolverService;
  ...
  beforeEach (inject ([PlacementCandidateDetailResolverService], (s: PlacementCandidateDetailResolverService) => {
    service = s;
  }));
  ...
  describe ('resolve ()', () => {
    ...
    describe ('Placement received', () => {
      beforeEach (async (() => {
        ...
        placementsService.testPlacementCandidate = {};
    ...
    describe ('Placement not received', () => {
      beforeEach (async (() => {
        ...
        placementsService.testPlacementCandidate = null;
    ...
    describe ('Error', () => {
      beforeEach (async (() => {
        ...
        placementsService.testPlacementCandidateError = 'Error';
